...
mod tests {
    ...
    fn paragraphs_hard_break() {
        let mut page = SwipePage::new(
            Paragraphs::new()
                .add::<theme::TTDefaultText>(theme::FONT_NORMAL, "Short one.")
                .add_break()
                .add::<theme::TTDefaultText>(theme::FONT_NORMAL, "Short two.")
                .add_break()
                .add::<theme::TTDefaultText>(theme::FONT_NORMAL, "Short three.")
                .add_break(),
            Empty,
            theme::BG,
        );
